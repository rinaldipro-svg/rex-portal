          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-gray-50 p-4 rounded border border-gray-100">
                ...
                <p className="font-bold text-gray-900 text-sm">{fiche.infrastructure}</p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded border border-gray-100">
                ...
                <p className="font-bold text-hqblue text-sm">{fiche.unspsc_code}</p>
              ...
              <div className="bg-gray-50 p-4 rounded border border-gray-100">
                ...
                <p className="font-bold text-gray-900 text-sm">{fiche.localisation}</p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mt-1">{fiche.contrainte}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mt-1">{fiche.environnement}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start border-l-2 border-hqorange pl-4 ml-3 mt-6">
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-medium mt-1">{fiche.lignerouge}</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="page bg-white max-w-[21cm] min-h-[29.7cm] mx-auto my-8 print:my-0 shadow-lg print:shadow-none border-t-8 border-corporate p-10 print:p-10 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{fiche.ingenierie}</p>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2 mb-1">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{fiche.securite}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 bg-corporate text-white p-8 rounded-xl shadow-inner">
            ...
            <div className="grid grid-cols-3 gap-8">
              {/* Métrique 1 */}
              <div>
                <div className="text-hqorange font-bold text-4xl mb-2">{fiche.metrique1_val}</div>
                <h3 className="text-sm font-bold text-white uppercase tracking-wide mb-2">
                  {fiche.metrique1_titre}
                </h3>
              ...
              {/* Métrique 2 */}
              <div>
                <div className="text-hqorange font-bold text-4xl mb-2">{fiche.metrique2_val}</div>
                <h3 className="text-sm font-bold text-white uppercase tracking-wide mb-2">
                  {fiche.metrique2_titre}
                </h3>
              ...
              {/* Métrique 3 */}
              <div>
                <div className="text-hqorange font-bold text-4xl mb-2">{fiche.metrique3_val}</div>
                <h3 className="text-sm font-bold text-white uppercase tracking-wide mb-2">
                  {fiche.metrique3_titre}
                </h3>
